...
const Footer = () => {
  ...
  return <footer className="text-secondary-foreground py-12" style={footerStyle}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 rtl">
          <div className="space-y-4">
            ...
            <p className="text-secondary-foreground/80 max-w-xs">منصة متخصصة في التحليل النفسي للأحلام باستخدام تقنيات الذكاء الاصطناعي المتقدمة استناداً إلى علم النفس الاسلامي.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 rtl:space-x-reverse">
              {themeSettings.twitterLink && <a href={themeSettings.twitterLink} target="_blank" rel="noopener noreferrer" className="text-secondary-foreground/80 hover:text-accent transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-twitter"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z" /></svg>
                </a>}
              {themeSettings.facebookLink && <a href={themeSettings.facebookLink} target="_blank" rel="noopener noreferrer" className="text-secondary-foreground/80 hover:text-accent transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                </a>}
              {themeSettings.instagramLink && <a href={themeSettings.instagramLink} target="_blank" rel="noopener noreferrer" className="text-secondary-foreground/80 hover:text-accent transition-colors">
