...
عن منصة تأويل</h1>
            ...
            <div className="prose prose-lg prose-blue max-w-none">
              <h2 className="text-2xl font-semibold mb-4 text-foreground">مرحبًا بك في منصة تأويل </h2>
              <p className="mb-6 text-foreground/80">منصة تفسير الأحلام هي خدمة مبتكرة تجمع بين المعرفة التقليدية لتفسير الأحلام والتكنولوجيا الحديثة للذكاء الاصطناعي. نحن نهدف إلى تقديم تفسيرات دقيقة ومفيدة للأحلام استنادًا إلى مصادر علم النفس الاسلامي الحديث.</p>
              ...
              <p className="mb-4 text-foreground/80">يستخدم نظامنا الذكاء الاصطناعي المتقدم الذي تم تدريبه على آلاف التفسيرات النفسية التحليلية استناداً إلى مصادر علم النفس الاسلامي الحديث.</p>
              ...
              <p className="mb-6 text-foreground/80">عندما تقوم بإدخال حلمك، يقوم النظام بتحليل العناصر الرئيسية في الحلم ومقارنتها مع قاعدة البيانات الخاصة بنا، ثم يقدم تفسيرًا شاملًا ودقيقًا.</p>
