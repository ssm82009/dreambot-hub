          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="firstName" placeholder="الاسم الأول" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName">الاسم الأخير</Label>
                  <Input id="lastName" placeholder="الاسم الأخير" required />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="confirmPassword" type="password" placeholder="أعد إدخال كلمة المرور" required />
              </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-foreground/70">أو التسجيل بواسطة</span>
              </div>
            </div>
